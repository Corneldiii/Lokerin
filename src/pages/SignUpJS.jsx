          ...
          <div className="w-full rounded-4xl h-fit p-10 flex flex-col justify-center items-center gap-10">
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                name="EmailJS"
                id="email-js"
                className='shadow-xl border-1 rounded-2xl h-10 md:h-15 w-80 md:w-150 p-5 font-bold font-manrope  md:text-2xl' placeholder='Email'
                onBlur={(e) => {
            ...
            <div className="flex flex-col">
              ...
              <div className="">
                <input
                  ...
                  className='shadow-xl border-1 rounded-2xl h-10 md:h-15 w-80 md:w-150 p-5 font-bold font-manrope md:text-2xl'
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                name="PassVerJS"
                id="passVerifJS"
                className='shadow-xl border-1 rounded-2xl h-10  md:h-15 w-80 md:w-150 p-5 font-bold font-manrope md:text-2xl' placeholder='Password' />
                <button
                  type="button"
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center shadow-xl rounded-2xl overflow-hidden w-80 md:w-150 border-1">
                <span className="bg-gray-200 px-4 py-4 text-lg md:text-2xl font-bold text-gray-700">+62</span>
                <input
                  type="tel"
                  inputMode='numeric'
                  name="PhoneJS"
                  id="phoneJS"
                  className="flex-1 h-10  md:h-15 p-3 font-bold font-manrope md:text-2xl outline-none"
