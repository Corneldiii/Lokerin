        ...
        <div className='fixed top-0 left-0 w-full z-10 shadow backdrop-blur-3xl'>
            <div className="container mx-auto flex justify-between items-center py-4 px-6 md:px-3 lg:px-5">
                ...
                <ul className='hidden md:flex gap-7'>
                    <Link to='header' smooth={true} duration={500} className='cursor-pointer text-lg hover:text-gray-300'>Home</Link>
                    <Link to='quick' smooth={true} duration={500} offset={-100} className='cursor-pointer text-lg hover:text-gray-300'>Quick Fact</Link>
